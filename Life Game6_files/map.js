var Map = function(canvasId, lines, columns, livingCells) {
	...
	this.render = function() {
		$("living_cells").value = this.livingCells;
		this.context.fillStyle = this.colorList.border.hex;
...
//		    this.context.moveTo(1,1);//(i * this.cellWidth, j * this.cellHeight);
//		    this.context.lineTo(100,100);//(i * this.cellHeight + this.cellWidth / 4, j * this.cellHeight + this.cellHeight / 2)
		    }
		  --j;
		  }
		i = i-1;
